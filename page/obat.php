                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        while($row = mysqli_fetch_array($obat)) { 
                          ...
                          <tr>
                          <td><?php echo $No++; ?></td>
                          <td><?php echo $row['NOMED_PASIEN'];?></td>
                          ...
                          <td> 
                            <a href="detail.php?NOMED_PASIEN=<?php echo $row['NOMED_PASIEN']; ?>">DETAIL |</a>
                            <a href="input.php?NOMED_PASIEN=<?php echo $row['NOMED_PASIEN']; ?>">INPUT |</a>
                            <!-- 
